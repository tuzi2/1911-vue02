      ...
      <article class="container articles">
        <div class="row">
          ...
          <div class="col-sm-12 col-md-9 p0 wrap-headline">
            <img src="@/assets/static/img/content/article.jpg" alt="img" class="wrap-headline__img">
          ...
          <div class="col-sm-12 col-md-9 article_text">
            <div class="current">
              ...
              <img src="@/assets/static/img/content/article2.jpg" alt="img" class="current__img">
          ...
          <div class="col-sm-9 col-md-8 col-lg-6 comments">
            ...
            <div class="comments__media">
              <div class="media-middle">
                <i class="media-object" style="background-image: url('@/assets/static/img/content/comment.png')"></i>
                <div class="comm_info">
